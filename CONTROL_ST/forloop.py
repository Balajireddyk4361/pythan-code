...
# print all employ names using for looop
# for emp in employees:
#     print(emp['ename'])

#print employ names using while
...
#print all male employees names using for loop
# for emp in employees:
#     if emp['gender']=='Male':
#         print(emp['ename'])


#print no of female gender and name using while loop
# i=1
# while i<=len(employees)-1:
